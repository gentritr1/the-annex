...
| `public/images/case-81-deposition-annex.webp` | Locally encoded from the generated master (sips, 1720 px wide, quality 82) | Responsive delivery of the Case 81 background, wired at the scene's raster plug point (the only Case 81 artwork shipped in `dist/`) | Derived optimization; PNG master retained in `docs/assets/` |
